...
const Navbar = () => {
  ...
  return (
    <nav className="z-50 fixed bg-dav-gray grid text-sm text-center w-full lg:text-sm sm:text-3xl lg:font-semibold lg:text-white/80 md:justify-end md:justify-self-end lg:px-5 lg:py-3">
        ...
        <a className="mx-4 my-3" href="#Home"><span className="text-dav-green">#</span>Home</a>
        <a className="mx-4 my-3" href="#Skills"><span className="text-dav-green">#</span>Skills</a>
        <a className="mx-4 my-3" href="#Projects"><span className="text-dav-green">#</span>Projects</a>
        <a className="mx-4 my-3" href="#Contact"><span className="text-dav-green">#</span>Contact</a>
        </div>
