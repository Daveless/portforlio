...
const Section2 = () => {
  return (
    <section id="Skills" className="w-[80%] max-w-[800px] m-auto">
      ...
      <Lottie className="w-[15rem] md:w-[55rem] mx-auto" animationData={animationData}/>
      <div className="grid grid-cols-2 md:grid-cols-1 md:w-full gap-3 md:gap-5 text-white">
        <div className="flex flex-col border border-dav-border-gray w-full">
            <div className="border border-dav-border-gray py-1 px-2">Languages</div>
            <div className="p-2">
        ...
        <div className="flex flex-col border border-dav-border-gray w-full">
            <div className="border border-dav-border-gray py-1 px-2">Frameworks</div>
            <div className="p-2">
