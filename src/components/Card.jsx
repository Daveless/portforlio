  ...
  return (
    <div className="border border-dav-border-gray text-dav-border-gray">
      ...
      <div className="p-4 border border-dav-border-gray">
        ...
        <p className="py-4">{isEng ? work.description : work.descriptionSpa}</p>
        <div className="w-full flex gap-2 justify-around">
          <a
            className="w-[8rem] text-center py-1 px-6 border border-dav-green hover:bg-dav-green hover:text-black transition-colors delay-150"
            target="_blank"
            rel="noreferrer"
            href={work.webSite}
          >
